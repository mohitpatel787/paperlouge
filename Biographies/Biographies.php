...
$con = mysqli_connect("localhost","root","","db1");
    $res = $con->query("select * from biographies ");
    if($res->num_rows==0){
...
<link rel="stylesheet" type="text/css" href="StyleCategs.css">
...
<body class="bgbi">
  ...
  <div class="navbar-header">
    ...
    <h1 style="font-family: 'Permanent Marker', cursive; padding-left: 50px;padding-bottom: 0px; padding-top: 0px; font-size: 70px;color: white">♦ Biographies</h1>
</div>
                ...
                <div class="col-md-3">
                    <div class="well" style="width: 95%;">
                        ...
                        <div class="caption">
                            ...
                            <p><a href="bookdetails.php?Biographies=<?php echo  $result['id'];?>" class="btn btn-primary">View</a>  <a href="<?php echo $result['buy'] ?>" class="btn btn-default">Read</a></p>
                        </div>
                    </div>
                </div>
            <?php $count++; 
