...
$con = mysqli_connect("localhost","root","","db1");
    $res = $con->query("select * from  novel ");
    if($res->num_rows==0){
...
<body class="bgn">
  ...
  <div class="navbar-header">
    ...
    <h1 style="font-family: 'Permanent Marker', cursive; padding-left: 50px;padding-bottom: 0px; padding-top: 0px; font-size: 70px;color: white">♦ Novels</h1>
</div>
                ...
                <div class="col-md-3">
                    <div class="well" style="width: 95%;">
                        ...
                        <div class="caption">
                            ...
                            <p class="text-justify"><?php echo substr($result['info'],0,150).'...';?></p>
                            <p><a href="bookdetails.php?Novels=<?php echo  $result['id'];?>" class="btn btn-primary">View</a>  <a href="<?php echo $result['buy'] ?>" class="btn btn-default">Read</a></p>
                        </div>
                    </div>
                </div>
            <?php $count++; 
