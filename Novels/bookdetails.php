...
if(!empty($_GET['Novels'])){
  $res = $con->query("select * from novel where id='".$_GET['Novels']."'");
    if($res->num_rows==0){
         ...
         <div class="container" id="cat">
              <h1 style="font-family: 'Nixie One', cursive; font-size: 30px; "><strong>Categories</strong></h1>
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <a style="color: black;" href="../Novels/Novels.php"> <span class="fa fa-angle-double-right text-primary"></span>   Novels</a>
                    </li>
                     <li>
