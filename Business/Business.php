...
<link rel="stylesheet" type="text/css" href="StyleCategss.css">
...
<body class="bgb">
  ...
  <div class="navbar-header">
    ...
    <h1 style="font-family: 'Permanent Marker', cursive; padding-left: 50px;padding-bottom: 0px; padding-top: 0px; font-size: 70px;color: white">♦ Business</h1>
</div>
                ...
                <div class="col-md-3">
                    <div class="well" style="width: 95%;">
                        ...
                        <div class="caption">
                            ...
                            <p><a href="bookdetails.php?bussiness=<?php echo  $result['id'];?>" class="btn btn-primary">View</a>  <a href="<?php echo $result['buy'] ?>" class="btn btn-default">Read</a></p>
                        </div>
                    </div>
                </div>
            <?php $count++; 
