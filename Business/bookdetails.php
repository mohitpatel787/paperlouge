...
if(!empty($_GET['bussiness'])){
	$res = $con->query("select * from bussiness where id='".$_GET['bussiness']."'");
    if($res->num_rows==0){
         ...
         <div class="container" id="cat">
              <h1 style="font-family: 'Nixie One', cursive; font-size: 30px; "><strong>Categories</strong></h1>
                  ...
                  <ul class="list-unstyled">
                    <li>
                      <a href="../Biographies/Biographies.php"> <span class="fa fa-angle-double-right text-primary"></span>   Biographies</a>
                    </li>
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                      <a style="color: black;" href="../Business/Business.php"> <span class="fa fa-angle-double-right text-primary"></span>   Buisness</a>
                    </li>
...
<hr>
     ...
     <hr>
          <!-- Post Content -->
          <h4 class="text-justify"><?php echo $result['describe'];?> </h4>
