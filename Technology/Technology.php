...
$con = mysqli_connect("localhost","root","","db1");
    $res = $con->query("select * from technology ");
    if($res->num_rows==0){
...
<link href="https://fonts.googleapis.com/css?family=Comfortaa|Crushed|Montserrat|Gugi|Amatic+SC|Cinzel|Permanent+Marker" rel="stylesheet">
</head>
<body class="bgt">
  ...
  <div class="navbar-header">
    ...
    <h1 style="font-family: 'Permanent Marker', cursive; padding-left: 50px;padding-bottom: 0px; padding-top: 0px; font-size: 70px;color: white">♦ Technology</h1>
</div>
                ...
                <div class="col-md-3">
                    <div class="well" style="width: 95%;">
                        ...
                        <div class="caption">
                            ...
                            <p class="text-justify"><?php echo substr($result['describe'],0,100).'...';?></p>
                            <p><a href="bookdetails.php?Technology=<?php echo  $result['id'];?>" class="btn btn-primary">View</a>  <a href="<?php echo $result['buy'] ?>" class="btn btn-default">Read</a></p>
                        </div>
                    </div>
                </div>
            <?php $count++; 
