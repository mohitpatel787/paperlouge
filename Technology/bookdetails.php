...
if(!empty($_GET['Technology'])){
	$res = $con->query("select * from technology where id='".$_GET['Technology']."'");
    if($res->num_rows==0){
         ...
         <div class="container" id="cat">
              <h1 style="font-family: 'Nixie One', cursive; font-size: 30px; "><strong>Categories</strong></h1>
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li class="active">
                      <a style="color: black;" href="../Technology/Technology.php"> <span class="fa fa-angle-double-right text-primary"></span>   Technology</a>
                    </li>
                    <li>
