...
if(!empty($_GET['Science'])){
	$res = $con->query("select * from science where id='".$_GET['Science']."'");
    if($res->num_rows==0){
         ...
         <div class="container" id="cat">
              <h1 style="font-family: 'Nixie One', cursive; font-size: 30px; "><strong>Categories</strong></h1>
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <a style="color: black;" href="../Science/Science.php"> <span class="fa fa-angle-double-right text-primary"></span>   Science</a>
                    </li>
                  </ul>
...
<hr>
     ...
     <hr>
          <!-- Post Content -->
          <p class="text-justify"><?php echo $result['info'];?> </p>
