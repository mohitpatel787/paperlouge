...
$con = mysqli_connect("localhost","root","","db1");
    $res = $con->query("select * from science ");
    if($res->num_rows==0){
...
<link href="https://fonts.googleapis.com/css?family=Permanent+Marker|Gruppo|Nixie+One|Crushed" rel="stylesheet">
...
<body class="bgs">
  ...
  <div class="navbar-header">
        ...
        <a class="navbar-brand" style="font-family: 'Crushed', cursive;font-size: 35px"><strong>PaperLouge</strong></a>
        </div>
    ...
    <h1 style="font-family: 'Permanent Marker', cursive; padding-left: 50px;padding-bottom: 0px; padding-top: 0px; font-size: 70px;color: white">♦ Science</h1>
</div>
            ...
            ?>            
                <div class="col-md-3">
                    <div class="well" style="width: 95%;">
                        ...
                        <div class="caption">
                            <h4 style="font-weight: bold;"><?php echo $result['Book_Name'];?></h4>
                            <h5 style="font-weight: bold;color: #391313"><?php echo $result['author'];?></h5>
                            <p class="text-justify"><?php echo substr($result['info'],0,100).'...';?></p>
                            <p><a href="bookdetails.php?Science=<?php echo  $result['id'];?>" class="btn btn-primary">View</a>  <a href="<?php echo $result['buy'] ?>" class="btn btn-default">Read</a></p>
                        </div>
                    </div>
                </div>
            <?php $count++; 
