...
if(!empty($_GET['SelfHelp'])){
	$res = $con->query("select * from selfhelp where id='".$_GET['SelfHelp']."'");
    if($res->num_rows==0){
         ...
         <div class="container" id="cat">
              <h1 style="font-family: 'Nixie One', cursive; font-size: 30px; "><strong>Categories</strong></h1>
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <a style="color: black;" href="../SelfHelp/SelfHelp.php"> <span class="fa fa-angle-double-right text-primary"></span>   Self-Help</a>
                    </li>
